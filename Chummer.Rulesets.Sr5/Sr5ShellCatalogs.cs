...
internal static class Sr5DesktopUiControlCatalog
{
    public static readonly IReadOnlyList<DesktopUiControlDefinition> All = CreateCatalog();

    private static IReadOnlyList<DesktopUiControlDefinition> CreateCatalog()
    {
        return
        [
