...
| WL-004 | in_progress | P2 | Triage test/build analyzer warning backlog and prioritize zero-risk cleanups. | agent | 2026-03-05 progress: cleared `CA2263`, `CA1847`, `CS0067`, and `CA1859`. Latest docker-tests build: `417 Warning(s)`, `0 Error(s)`, `390/390` tests passed (`/tmp/chummer-docker-tests.log`). Dominant per-build buckets now MSTEST0037 (~211), CS8632 (~184), CA1861 (~19). |
