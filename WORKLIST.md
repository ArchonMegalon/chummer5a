...
| WL-015 | in_progress | P1 | Milestone 9 platform cleanup: maintain Avalonia shell composition parity. | agent | Re-audit `MainWindow.axaml.cs` for residual shell logic and keep it as composition glue over shared shell surface/presenter state. |
