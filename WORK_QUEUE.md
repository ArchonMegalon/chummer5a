...
| WQ-012 | in_progress | P1 | Milestone 3: extend bootstrap/session snapshot with active workspace session fields. | agent | Add `ActiveWorkspaceId` (and optional tab state), persist/restore in bootstrap, and update presenter initialization flow. |
