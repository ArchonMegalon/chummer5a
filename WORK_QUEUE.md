...
| WQ-015 | in_progress | P1 | Milestone 5: make shell surface resolution the only renderer-facing shell model. | agent | Expand/normalize `ShellSurfaceState` usage and remove remaining renderer-side shell interpretation drift between Blazor and Avalonia heads. |
