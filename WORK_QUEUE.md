...
| WQ-011 | in_progress | P1 | Milestone 2: introduce dedicated shell preferences service boundary. | agent | Add `IShellPreferencesStore`/`IShellPreferencesService` and migrate endpoints + clients away from raw `"global"` settings key plumbing. |
