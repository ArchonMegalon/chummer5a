...
| WQ-014 | in_progress | P1 | Milestone 4: split generic ruleset hosting infrastructure out of `Chummer.Rulesets.Sr5`. | agent | Create neutral ruleset-hosting module/registration (`AddRulesetInfrastructure`) and keep SR5 module scoped to SR5 plugin registrations (`AddSr5Ruleset`). |
